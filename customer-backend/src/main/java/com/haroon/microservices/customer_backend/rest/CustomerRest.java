package com.haroon.microservices.customer_backend.rest;
...
/**
 * Rest service of the Customer class has only two capability. To return a list of customers and 
 * return a customer based on the provided id.
...
public class CustomerRest {
	...
	/**
	 * Provides a customer based on the id
	 * @param id customer id
	 * @return returns specific customer with id
	 */
